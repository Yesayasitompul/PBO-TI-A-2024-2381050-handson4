public class DenganMethod {
    public static void main(String[] args) {
        ...
        int gajeBersih = hitungaGajiBersih(totalPenghasilan, pajak);

        tampilkanDetailGaji(gajiPokok, tunjanganTransport, tunjanganMakan, bonus, pajak, gajeBersih);
    }
    ...
    public static int hitungaGajiBersih(int totalPenghasilan, int pajak) {
